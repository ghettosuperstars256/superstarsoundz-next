              ...
              >
                ...
                <div style={{ padding: '1.25rem' }}>
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                    <a href={`/gear/${product.slug}`} target="_blank" className="btn-ghost" style={{ flex: 1, minWidth: '70px', fontSize: '0.75rem', padding: '0.375rem', textAlign: 'center' }}>View</a>
                    <Link href={`/dashboard/admin/editor?type=product&id=${product.id}`} className="btn-ghost" style={{ flex: 1, minWidth: '70px', fontSize: '0.75rem', padding: '0.375rem', textAlign: 'center', color: '#3b82f6' }}>Edit</Link>
                    <a href={product.external_url} target="_blank" rel="noopener noreferrer" className="btn-ghost" style={{ flex: 1, minWidth: '70px', fontSize: '0.75rem', padding: '0.375rem', textAlign: 'center', color: '#D4A843' }}>Affiliate</a>
                  </div>
                </div>
              </div>
            );
